...
- [ ] Консьюмер `kb.article.updated` — репликация link-уроков (§10.2).
- [ ] Назначения (user/position/department/external + inviteToken), прогресс, воркер дедлайнов. Переключение модуля.
